...
XMLHttpRequest = window.XMLHttpRequest;
    ...
    r.prototype.e = function(e) {
        ...
        case 0:
            ...
            break;
        case 1:
            for (var r = e.f.pop(), a = [], i = 0; i < this.i; i++)
                a.unshift(e.f.pop());
            e.r[3] = e.r[this.s][r](a[0], a[1]);
            break;
        case 2:
            for (var o = [], s = 0; s < this.i; s++)
                o.unshift(e.f.pop());
            e.r[3] = new e.r[this.s](o[0],o[1])
        }
    }
    ;
    var k = function(e) {
    ...
    G.prototype.D = function(e) {
        for (var t = window.atob(e), n = t.charCodeAt(0) << 8 | t.charCodeAt(1), r = [], a = 2; a < n + 2; a += 2)
            r.push(t.charCodeAt(a) << 8 | t.charCodeAt(a + 1));
        this.G = r;
        for (var i = [], o = n + 2; o < t.length; ) {
            var s = t.charCodeAt(o) << 8 | t.charCodeAt(o + 1)
              , c = t.slice(o + 2, o + 2 + s);
            i.push(c),
            o += s + 2
        }
